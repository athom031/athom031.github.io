...
In my professional experience, I was able to work as an intern at Knowles Intelligent Audio and explore the audio space. A reoccurring theme in my history is my drive for exploring new fields which comes from holding onto my passion for learning. And that passion for learning is what pushed me to get experience in artificial intelligence, embedded systems, and full stack development and are demonstrated in projects found on the home page. Ultimately my journey has brought out the skill I have for working with people to solve problems. 
